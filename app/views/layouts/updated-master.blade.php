 ...
 <div class="clearfix">
  ...
  <div class="footer-col-2">
   ...
   <section>
	...
	<div id="mc_embed_signup" style="background: black;">
	<form action="//khemitology.us7.list-manage.com/subscribe/post?u=238d10a4d43535c14ac289459&amp;id=33d4b59d58" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate form form-inline" target="_blank" novalidate>
		<label for="mce-EMAIL"></label>
		<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" style="font-color: black;"required>
	    ...
	    <div class="clear"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button pull-right" style="position: relative; bottom: 44px;"></div>
	</form>
	</div>
	<!--End mc_embed_signup-->
